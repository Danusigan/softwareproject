...
export default function SuperAdminDashboard() {
    const [sidePanelOpen, setSidePanelOpen] = useState(null); // 'admin' or 'module'
    ...
    const handleAdminSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data.status === 'SUCCESS') {
                ...
                setAdminData({ username: '', email: '', password: '', usertype: 'Admin' });
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">Add an Admin</h2>
                        <p className="text-center text-gray-600">Click to add a new admin to the system</p>
                    </div>
            ...
            >
                <div className="p-6 h-full overflow-y-auto">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-2xl font-bold text-gray-800">Add an Admin</h2>
                        <button
                    ...
                    <form onSubmit={handleAdminSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setAdminData({ ...adminData, usertype: e.target.value })}
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                            >
