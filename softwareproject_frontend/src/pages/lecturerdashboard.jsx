        ...
        <div className="min-h-screen bg-[#f8fafc] flex flex-col relative overflow-hidden">
            ...
            <main className="flex-1 max-w-7xl mx-auto px-6 py-12 w-full relative z-10 animate-in fade-in duration-700">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-12">
                    ...
                    <button type="button" onClick={() => navigate('/my-cqi-plans')}
                        className="flex items-center gap-2 px-5 py-3 rounded-2xl bg-red-600 text-white font-bold hover:bg-red-700 transition-colors shadow-lg shadow-red-600/20">
